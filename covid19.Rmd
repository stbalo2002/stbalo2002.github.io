...
The world has done several analysis on the current novel coronavirus disease (COVID-19) pandemic. The bulk of the analysis has been focused on developed and high-income countries. This is a brief analysis of the current trend in Africa. I will be updating the charts periodically till the pandemic is contained, hopefully this will happen soon.   
...
The pandemic has spread across all the continents currently affecting over 180 countries, most of these countries were affected in March 2020. The graph below shows the spread across countries since inception.
...
It is no longer news that China, being the country where the first case was discovered experienced the pandemic much early and appear to have been able to contain the disease. The other country that has done remarkably well in containment appears to be South Korea. The country was able to flatten the curve early, something most other countries have not been able to do.  
...
## Comparing Cases and Fatality Across the Globe

A remarkable thing about COVID-19 is its variability, in terms of severity, infectivity (rapid spread) and mortality. The graph below shows the number of confirmed cases and reported mortality attributable (directly and indirectly) to COVID-19 across the world.  
