...
output: 
  html_document: 
    css: ~/R/win-library/3.3/knitr/themes/bluegreen.css
    fig_caption: yes
    fig_height: 3
    fig_width: 5
    highlight: tango
...
knitr::opts_chunk$set(echo = TRUE, verbose = FALSE, collapse = TRUE, error = FALSE, message = FALSE, warning = FALSE)
```
