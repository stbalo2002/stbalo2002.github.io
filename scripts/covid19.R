...
world <- covid_df %>%
  ...
  scale_x_date(date_breaks = "1 week", date_labels = "%b %d", minor_breaks = NULL) +
  scale_y_continuous(breaks = seq(from = 0, to = 200000, by = 20000), labels = scales::comma, minor_breaks = NULL) +
  rotateTextX(angle = 45) +
  labs(x = "Date", 
       y = "No of Cases",
...
ngr <- covid_df %>%
  ...
  theme_minimal() +
  scale_x_date(date_breaks = "1 week", date_labels = "%b %d", minor_breaks = NULL) +
  scale_y_continuous(breaks = seq(from = 0, to = 200, by = 10), minor_breaks = NULL) + 
  labs(x = "Date", 
       y = "No of Cases",
